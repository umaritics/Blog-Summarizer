  ...
  return (
    <footer className="bg-gray-100 text-black font-bebas-neue p-0 pt-10">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-16">
        ...
        <div className="space-y-4 text-center md:text-left mt-14">
          <h3 className="text-5xl mb-6 tracking-wide">Contact</h3>
          <ul className="space-y-2 text-sm text-gray-800">
            ...
            <li className="flex justify-center md:justify-start space-x-4 text-xl mt-2">
        ...
        <div className="space-y-4 text-center mt-14">
          <h3 className="text-5xl mb-6 tracking-wide">Legal</h3>
          <ul className="space-y-2 text-sm text-gray-800">
            <li>
        ...
        <form className="space-y-4 ">
          <h3 className="text-5xl text-center mb-2 tracking-wide">
            Get in Touch
          </h3>
          <input
            type="text"
            placeholder="Your Name"
            className="w-full p-2 bg-transparent border border-gray-500 text-black placeholder-gray-600 rounded-md outline-none focus:ring-2 focus:ring-black"
            required
          />
          <input
            type="email"
      ...
      <p className="text-center p-0 mb--10 mt-8 text-xl text-gray-600">
